...
const DashboardIcon: React.FC<{ fill: string }> = ({ fill = '#b8b8be' }) => {
    return (
        <svg
        ...
        >
            ...
            <g id="Category" transform="translate(2.7 2.7)">
                <path
                    ...
                    data-name="Stroke 1"
                    className="cls-1"
                    d="M0 3.151C0 .787.025 0 3.151 0S6.3.787 6.3 3.151 6.311 6.3 3.151 6.3 0 5.514 0 3.151z"
                />
                <path
                    id="Stroke_3"
                    data-name="Stroke 3"
                ...
                <path
                    ...
                    className="cls-1"
                    d="M0 3.151C0 .787.025 0 3.151 0S6.3.787 6.3 3.151 6.311 6.3 3.151 6.3 0 5.514 0 3.151z"
                    transform="translate(9.902 9.902)"
                />
            </g>
        </svg>
    );
